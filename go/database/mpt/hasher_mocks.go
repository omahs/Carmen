...
func (m *Mockhasher) encode(node Node, source NodeSource, target []byte) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "encode", node, source, target)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockhasherMockRecorder) encode(node, source, target any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "encode", reflect.TypeOf((*Mockhasher)(nil).encode), node, source, target)
}
